...
public class IsolationSegmentsServiceV3 extends Common {
    ...
    public ListIsolationSegmentsResponse getIsolationSegments() throws Exception {
        return cloudFoundryClient().isolationSegments().list(ListIsolationSegmentsRequest.builder().build()).block();
    }
    ...
    public ListIsolationSegmentsResponse getIsolationSegmentsByOrgGuid(String organizationsId) throws Exception {
        return cloudFoundryClient().isolationSegments().list(ListIsolationSegmentsRequest.builder().organizationId(organizationsId).build()).block();
    }
    ...
    public ListIsolationSegmentEntitledOrganizationsResponse getIsolationSegmentsOrgs(String isolationSegmentId) throws Exception {
        return cloudFoundryClient().isolationSegments().listEntitledOrganizations(ListIsolationSegmentEntitledOrganizationsRequest.builder().isolationSegmentId(isolationSegmentId).build()).block();
    }
    ...
    public ListIsolationSegmentOrganizationsRelationshipResponse getIsolationSegmentsOrgsRelationships(String isolationSegmentId) throws Exception {
        return cloudFoundryClient().isolationSegments().listOrganizationsRelationship(ListIsolationSegmentOrganizationsRelationshipRequest.builder().isolationSegmentId(isolationSegmentId).build()).block();
    }
    ...
    public ListIsolationSegmentSpacesRelationshipResponse getIsolationSegmentsSpaces(String isolationSegmentId) throws Exception {
        return cloudFoundryClient().isolationSegments().listSpacesRelationship(ListIsolationSegmentSpacesRelationshipRequest.builder().isolationSegmentId(isolationSegmentId).build()).block();
    }
    ...
    public CreateIsolationSegmentResponse createIsolationSegments(String segmentName) throws Exception {
        return cloudFoundryClient().isolationSegments().create(CreateIsolationSegmentRequest.builder().name(segmentName).build()).block();
    }
    ...
    public Map deleteIsolationSegments(String isolationSegmentId) throws Exception {
        ...
        try {
            cloudFoundryClient().isolationSegments().delete(DeleteIsolationSegmentRequest.builder().isolationSegmentId(isolationSegmentId).build()).block();
    ...
    public AddIsolationSegmentOrganizationEntitlementResponse enableIsolationSegments(String isolationSegmentId, String organizationsId) throws Exception {
        return cloudFoundryClient().isolationSegments().addOrganizationEntitlement(AddIsolationSegmentOrganizationEntitlementRequest.builder().isolationSegmentId(isolationSegmentId).data(Relationship.builder().id(organizationsId).build()).build()).block();
    }
    ...
    public Map disableIsolationSegments(String isolationSegmentId, String organizationsId) throws Exception {
        ...
        try {
            cloudFoundryClient().isolationSegments().removeOrganizationEntitlement(RemoveIsolationSegmentOrganizationEntitlementRequest.builder().isolationSegmentId(isolationSegmentId).organizationId(organizationsId).build()).block();

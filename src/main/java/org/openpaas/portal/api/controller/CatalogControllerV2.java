...
import org.openpaas.portal.api.service.CatalogServiceV2;
 ...
 */
@RestController
public class CatalogControllerV2 extends Common {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CatalogControllerV2.class);

    @Autowired
    private CatalogServiceV2 catalogServiceV2;
    ...
    public ListApplicationsResponse getCatalogAppList(@PathVariable String orgid, @PathVariable String spaceid, @RequestHeader(AUTHORIZATION_HEADER_KEY) String token) throws Exception {
        return catalogServiceV2.getCatalogAppList(orgid, spaceid, token);
    }

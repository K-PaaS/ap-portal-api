...
@Service
public class CatalogServiceV2 extends Common {

    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(CatalogServiceV2.class);
    ...
    @Autowired
    public CatalogServiceV2(SpaceServiceV2 spaceServiceV2, DomainServiceV2 domainServiceV2, AppServiceV2 appServiceV2, CommonService commonService) throws Exception {

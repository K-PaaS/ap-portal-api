...
import org.openpaas.portal.api.service.SpaceQuotaServiceV3;
 ...
 */
@RestController
public class SpaceQuotaControllerV3 extends Common {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SpaceQuotaControllerV3.class);

    @Autowired
    SpaceQuotaServiceV3 spaceQuotaServiceV3; // The Space Quota service.
